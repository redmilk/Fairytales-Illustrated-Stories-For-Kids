...
final class ManageSubscriptionsViewModel: PurchesServiceProvidable,
    ...
    private let coordinator: ManageSubscriptionsCoordinatorProtocol & Coordinatable
    private var bag = Set<AnyCancellable>()

    init(coordinator: ManageSubscriptionsCoordinatorProtocol & Coordinatable) {
        ...
        input.sink(receiveValue: { [weak self] action in
            ...
            case .howItWorks:
                self?.coordinator.displayHowItWorks()
            }
        })
        .store(in: &bag)
